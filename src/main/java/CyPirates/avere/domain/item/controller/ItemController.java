...
public class ItemController {
    ...
    @PostMapping("/register/{programId}")
    public ResponseEntity<ItemDto.Response> registerItem(@PathVariable Long programId, @RequestBody ItemDto.Register request) {
    ...
    @PutMapping("/{itemId}")
    public ResponseEntity<ItemDto.Response> updateItem(@PathVariable Long itemId, @RequestBody ItemDto.Register request) {
